            ...
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(assets/media/bg/bg-2.jpg);">
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    ...
                    <div class="d-flex flex-center mb-15">
                        <a href="#">
                            <img src="assets/images/eoms-logo.png" class="max-h-75px" alt=""/>
                        </a>
                    </div>
                    <!--end::Login Header-->
                    ...
                    <div class="login-signin">
                        <div class="mb-20">
                            <h3 class="opacity-40 font-weight-normal">Sign in to Portal</h3>
                        ...
                        <form class="form" id="kt_login_signin_form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group text-center mt-10">
                                ...
                                <button type="submit" class="btn btn-pill btn-success opacity-90 px-15 py-3">Sign In</button>
                            </div>
                        </form>
                    </div>
