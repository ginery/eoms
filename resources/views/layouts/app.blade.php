   ...
   <body  id="kt_body"  class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading"  >
      ...
      <div class="d-flex flex-column flex-root">
         ...
         <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper" style="padding-top: 65px; padding-left: 200px;">
                ...
                background-image: url('{{asset('assets/images/bg-logo-1.png')}}');
                background-size: 65%; /* Adjust the size of the background */
      ...
      <script>
        ...
        <script>
         ...
         function handleRequirements(id) {
            ...
            $.ajax({
               ...
               data: {},
               success: function(response){
                    console.log("handleRequirements", response);
        ...
        function getProjectDetails(id, status){
            ...
            $.ajax({
               type: "POST",
               url: baseUrl + "/api/propose/details",
               data: {
                id: id,
                status: status
               },
        ...
        function handleUpdateStatus(id, status) {
            $.ajax({
               ...
               success: function(response){
                  console.log("handleUpdateStatus", response, 
               {
                  id: id,
                  status: status
               });
