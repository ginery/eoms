  ...
  <div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto"  id="kt_aside">
    <!--begin::Brand-->
    <div class="brand flex-row-auto " id="kt_brand">
       <!--begin::Logo-->
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
       ...
       <div id="kt_aside_menu" class="aside-menu my-4 "data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
          <!--begin::Menu Nav-->
          <ul class="menu-nav ">
             <li class="<?= $currentPageName === "dashboard" ? 'menu-item  menu-item-active': 'menu-item  menu-item-submenu'?>" aria-haspopup="true" >
             ...
             <li class="<?= $currentPageName === "propose" ? 'menu-item  menu-item-active': 'menu-item  menu-item-submenu'?>" aria-haspopup="true"  data-menu-toggle="hover">
               <a href="{{route('propose')}}" class="menu-link menu-toggle">
                  <span class="svg-icon menu-icon">
            ...
            <li class="<?= $currentPageName === "technical-review" ? 'menu-item  menu-item-active': 'menu-item  menu-item-submenu'?>" aria-haspopup="true"  data-menu-toggle="hover">
               <a href="{{route('technical-review')}}" class="menu-link menu-toggle">
                  <span class="svg-icon menu-icon">
            ...
            <li class="<?= $currentPageName === "in-house" ? 'menu-item  menu-item-active': 'menu-item  menu-item-submenu'?>" aria-haspopup="true"  data-menu-toggle="hover">
               <a href="{{route('in-house')}}" class="menu-link menu-toggle">
                  <span class="svg-icon menu-icon">
                     <span class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Group-folders.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                           <rect x="0" y="0" width="24" height="24"/>
                  ...
                  <span class="menu-text">In-house</span>
               </a>
            </li>
            ...
            <li class="<?= $currentPageName === "implementation" ? 'menu-item  menu-item-active': 'menu-item  menu-item-submenu'?>" aria-haspopup="true"  data-menu-toggle="hover">
               <a href="{{route('implementation')}}" class="menu-link menu-toggle">
                  <span class="svg-icon menu-icon">
                     <span class="svg-icon svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Group-folders.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                           <rect x="0" y="0" width="24" height="24"/>
            ...
            <li class="<?= $currentPageName === "completed" ? 'menu-item  menu-item-active': 'menu-item  menu-item-submenu'?>" aria-haspopup="true"  data-menu-toggle="hover">
               <a href="{{route('completed')}}" class="menu-link menu-toggle">
                  <span class="svg-icon menu-icon">
            ...
            <li class="<?= $currentPageName === "rejected" ? 'menu-item  menu-item-active': 'menu-item  menu-item-submenu'?>" aria-haspopup="true"  data-menu-toggle="hover">
               <a href="{{route('rejected')}}" class="menu-link menu-toggle">
                  <span class="svg-icon menu-icon">
